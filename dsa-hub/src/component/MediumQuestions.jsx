...
const MediumQuestions = ({ user }) => {
  ...
  useEffect(() => {
    const unsubscribe = getMediumQuestions();
    return () => unsubscribe;
  }, []);
                ...
                <tbody className="text-gray-500">
                  {questions.map((question) => (
                    <tr key={question.id}>
                      ...
                      <td className="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                        <span className="rounded-full bg-yellow-200 text-yellow-900 px-3 py-1 text-xs font-semibold">
                          {question.difficulty}
                        </span>
                      </td>
                    </tr>
